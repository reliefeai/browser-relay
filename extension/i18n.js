...
;(function () {
  const MESSAGES = {
    en: {
      ...
      statusConnectingHub: 'Connecting the extension to the hub…',
      statusRemoteConnected: 'Remote Relay is on and connected to the hub.',
      statusRemoteNoHub: "Device ID generated, but the hub isn't connected yet: ",
      statusRemoteNoReach: "Device ID generated, but the extension didn't reach the hub: ",
    ...
    zh_CN: {
      ...
      saveTest: '保存并测试连接',
      remoteRelay: '远程中继',
      remoteDesc: '从任何地方通过中转站控制<strong>这个</strong>浏览器 —— 不开放端口、不暴露本地服务。会生成一个保密的 Device ID,关闭前一直有效。想用自己的中转站?<a class="lnk" href="https://deploy.workers.cloudflare.com/?url=https://github.com/reliefeai/browser-relay/tree/main/hub" target="_blank" rel="noopener">部署到 Cloudflare →</a>',
      remoteHub: '远程中转站',
      ...
      statusConnectingHub: '正在把插件连接到中转站…',
      statusRemoteConnected: 'Remote Relay 已开启并连上中转站。',
      statusRemoteNoHub: '已生成 Device ID,但中转站还没连上:',
      statusRemoteNoReach: '已生成 Device ID,但插件没连上中转站:',
